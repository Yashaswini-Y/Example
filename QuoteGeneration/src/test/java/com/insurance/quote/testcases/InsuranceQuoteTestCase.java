...
public class InsuranceQuoteTestCase {
	...
	public void testGetUser() {
		...
		User_Role user=service.getUser("Sanjana@User");
		assertNotNull(user);
	}
	@Test
	public void testGetAccountNumber() {
		InsuranceServiceImpl service=new InsuranceServiceImpl();
		long accNum=service.getAccountNumber("Keerthi@User");
		assertEquals(1234567804,accNum);
	}
	@Test
	public void testCreateProfile() {
		UserRoleServiceImpl service=new UserRoleServiceImpl();
		User_Role user=new User_Role("Agent01","Agent@1","Agent");
	...
	public void testGetDetails() {
		...
		List<Accounts> account=service.getDetails(1234567801);
	...
	public void testGetAns() {
		ReportGenerationServiceImpl service=new ReportGenerationServiceImpl();
		List<String> ans=service.getAns(1234567801);
	...
	public void testGetFinalPremium() {
		ReportGenerationServiceImpl service=new ReportGenerationServiceImpl();
		double premium=service.getFinalPremium(1234567801);
