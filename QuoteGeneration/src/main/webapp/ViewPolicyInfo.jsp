...
<%}else{ %>
<tr><td>Policy Number</td><td><%= list.get(0).getPolicy_Number()%></td></tr>
<tr><td>Premium</td><td><%=list.get(0).getPolicy_Premium() %></td></tr>
<tr><td>Account Number</td><td><%=list.get(0).getAccount_Number()%></td></tr>
</table>
<%} %><br>
